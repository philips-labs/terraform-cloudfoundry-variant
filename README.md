...
| <a name="input_prometheus_evaluation_interval"></a> [prometheus\_evaluation\_interval](#input\_prometheus\_evaluation\_interval) | prometheus rules evaluation interval | `string` | `"15s"` | no |
...
| <a name="input_prometheus_scrape_interval"></a> [prometheus\_scrape\_interval](#input\_prometheus\_scrape\_interval) | prometheus scrape interval | `string` | `"15s"` | no |
